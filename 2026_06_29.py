...
train_input = fish_data[:35]    #파이썬 리스트
train_target = fish_target[:35] #파이썬 리스트

test_input = fish_data[35:]     #파이썬 리스트
test_target = fish_target[35:]  #파이썬 리스트
...
index = np.arange(49) #임의의 숫자를 몇개 만들꺼냐
